...
const confettiColors = ["#60A5FA", "#A78BFA", "#7C3AED", "#818CF8", "#C4B5FD"];
...
export default function CakeScreen({ onNext, onDecorate }) {
  ...
  return (
    <div className="px-4 md:px-6 py-10 text-center relative">
      {lit && (
        <motion.div className="fixed top-50 lg:top-60 left-0 w-full text-center text-[40px] md:text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-purple-400 to-violet-400 drop-shadow leading-tight px-4"
          style={{ filter: "drop-shadow(0 0 20px rgba(96,165,250,0.4))" }}
          initial={{ opacity: 0, scale: 0.8, }}
          animate={{ opacity: 1, scale: 1, }}
          transition={{ duration: 1, ease: "easeOut", delay: 1.5 }}
        >
          Happy Birthday, Abu Bakar! 🎉🔥🎂
        </motion.div>
      )}
